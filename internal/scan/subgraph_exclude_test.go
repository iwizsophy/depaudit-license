...
func TestApplySubgraphExcludesRemovesOnlySourceLocalExclusiveNodes(t *testing.T) {
	...
	result := Result{
		Packages: []Package{
			{Ecosystem: "dotnet", Project: "App", Name: "Analyzer.Core", Version: "1.0.0", DependencyType: "dependency", HasRuntimeAssets: false},
			{Ecosystem: "dotnet", Project: "App", Name: "Build.Helper", Version: "1.0.0", DependencyType: "transitiveDependency", HasRuntimeAssets: false},
			{Ecosystem: "dotnet", Project: "App", Name: "Runtime.Core", Version: "2.0.0", DependencyType: "dependency", HasRuntimeAssets: true},
			{Ecosystem: "dotnet", Project: "App", Name: "Shared.Lib", Version: "1.0.0", DependencyType: "transitiveDependency", HasRuntimeAssets: true},
		...
		Graphs: []DependencyGraph{{
			...
			Nodes: []DependencyGraphNode{
				{ID: "Analyzer.Core/1.0.0", Package: Package{Ecosystem: "dotnet", Project: "App", Name: "Analyzer.Core", Version: "1.0.0", DependencyType: "dependency", HasRuntimeAssets: false}},
				{ID: "Build.Helper/1.0.0", Package: Package{Ecosystem: "dotnet", Project: "App", Name: "Build.Helper", Version: "1.0.0", DependencyType: "transitiveDependency", HasRuntimeAssets: false}},
				{ID: "Runtime.Core/2.0.0", Package: Package{Ecosystem: "dotnet", Project: "App", Name: "Runtime.Core", Version: "2.0.0", DependencyType: "dependency", HasRuntimeAssets: true}},
				{ID: "Shared.Lib/1.0.0", Package: Package{Ecosystem: "dotnet", Project: "App", Name: "Shared.Lib", Version: "1.0.0", DependencyType: "transitiveDependency", HasRuntimeAssets: true}},
			},
